...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkUserQuery = "SELECT * FROM jam_tbl WHERE email_address = :email";
    ...
    try {
        ...
        if ($stmt1->rowCount() > 0) {
            ...
            if (strlen($password) < 8 || !preg_match('@[A-Z]@', $password) || !preg_match('@[a-z]@', $password) || !preg_match('@[0-9]@', $password) || !preg_match('/[!@#$%^&*(),.?":{}|<>]/', $password)) {
                ...
                $insertQuery = "INSERT INTO jam_tbl (user_name, first_name, middle_name, last_name, gender, birthdate, age, email_address, password) VALUES (:user_name, :firstName, :middleName, :lastName, :gender, :birthdate, :age, :email, :password)";
